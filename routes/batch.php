...
Route::middleware(['auth', 'verified'])->group(function () {
	Route::get('/progress/index', [BatchProgressController::class, 'index'])->name('progress.index');
	Route::get('/progress/downloadCSV', [BatchProgressController::class, 'downloadCSV'])->name('progress.downloadCSV');
});
